# From https://github.com/ErikBoesen/ocrspace
# Latest version not available on pypy at time of writing
...
class API:
    def __init__( self, api_key='helloworld', language=Language.English, **kwargs ):
        """
